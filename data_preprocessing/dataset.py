#!/usr/bin/env python
# -*- coding:utf-8 -*-
from data_preprocessing.utils import label_format
import yaml
import os
from typing import Dict, Type
from data_preprocessing.jointer import JointER


class Dataset:
    def __init__(self, name: str, path: str, data_class: Type[JointER], split_dict: Dict, language: str, mapper: Dict,
    ...
    def load_yaml_file(yaml_file):
        ...
        return Dataset(
            ...
            data_class=JointER,  # 数据集对应的 Task Format 名字 Raw data loader
