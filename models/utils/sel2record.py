...
from models.utils.record import EntityRecord, MapConfig, RelationRecord, EventRecord
import logging
...
class SEL2Record:
    def __init__(self, schema_dict, decoding_schema, map_config: MapConfig) -> None:
        ...
        self._predict_parser = SpotAsocPredictParser(label_constraint=schema_dict['record'])
